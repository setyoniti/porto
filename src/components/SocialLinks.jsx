...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "http://www.linkedin.com/in/setyo-niti-wicaksono",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@tyooaj",
    icon: Instagram,
    url: "https://www.instagram.com/tyooaj",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "Setyo Niti Wicaksono",
    icon: Youtube,
    url: "https://m.youtube.com/channel/UC43huHF6tgpt-ttyd0nppVQ",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@setyoniti",
    icon: Github,
    url: "https://github.com/setyoniti",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@tyzf_?_t=8sdJbCbR556&_r=1",
    color: "black",
